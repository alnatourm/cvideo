...
const styles = StyleSheet.create({
  ...
  videoEmptyText: { color: '#FFF', fontWeight: '850' },
  ...
  remove: { color: colors.danger, fontWeight: '850', fontSize: 11 },
  mono: { color: colors.muted, fontSize: 11 },
  interviewRow: { borderTopWidth: 1, borderTopColor: colors.line, paddingTop: 12, gap: 5 },
  interviewTitle: { color: colors.ink, fontWeight: '850', fontSize: 15 },
});
